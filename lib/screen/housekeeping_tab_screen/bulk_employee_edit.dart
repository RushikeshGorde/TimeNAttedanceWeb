...
import 'package:time_attendance/controller/housekeeping_controller/bulk_employee_edit_controller.dart';
...
class bulkemployeeeditscreen extends StatefulWidget {
  const bulkemployeeeditscreen({super.key});

  @override
  State<bulkemployeeeditscreen> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<bulkemployeeeditscreen> {
  final TextEditingController searchController = TextEditingController();
  final TextEditingController _searchController = TextEditingController();
  final BulkEmployeeeditController controller = Get.find<BulkEmployeeeditController>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Employees Bulk (update Information)'),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                        height: 36,
                        width: 200,  // Added fixed width for consistent button sizes
                        child: OutlinedButton(
                          ...
                          onPressed: () {},
                          child: Text("Upload Employees"),
                        ),
                      ),
                      const SizedBox(width: 60),  // Increased spacing between buttons
                      SizedBox(
                        height: 36,
                        width: 150,  // Added fixed width for consistent button sizes
                        child: OutlinedButton(
                          style: OutlinedButton.styleFrom(
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(8),
